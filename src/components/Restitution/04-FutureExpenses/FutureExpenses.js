...
export const FutureExpenses = () => {
  ...
  return form.values.MedicalExpenses &&
    ...
    <FormizStep label={`Future Medical Expenses`} name="FutureExpenses" order={4000}>
      <SectionWrapper>
        <SectionHeader header={`Future Medical Expenses`}
                       helpText={{
                         text:
        ...
        {expenses === "yes" && estimate === "no" && (
          <Box borderRadius="lg"  p={8} mb={4} bg="yellow.50" fontSize={"md"} mb={4}>
            Add info on how to estimate.
          </Box>
        )}
        {expenses === "yes" &&
          estimate === "yes" &&
