  ...
  return (
    <FormizStep label="Preparation checklist" name="introPrep" order={1000}>
      ...
      <Text p={4} mt={2} color={colorMode === "dark" ? "gray.600" : "gray.500"}>
        You will need some or all of the following information for yourself AND
        the other parent, and will need to answer detailed questions about all
        children related to both parties.
      </Text>
