...
export const TaxableIncomeSecondary = () => {
  ...
  return (
    <>
      {(form.values.OtherIncomeSecondary && form.values.OtherIncomeSecondary.taxable === true) && (
        <FormizStep name="TaxableIncomeSecondary" order={19000}>
          <SectionHeader header={`Enter ` + otherParent + `'s other taxable income:`} />
            ...
            {collection.map(({ id, name }, index) => (
              ...
              >
                ...
                <Box flex="1">
                  ...
                  form.values.TaxableIncomeSecondary[index].type === "other" && (
                    <FieldInput
