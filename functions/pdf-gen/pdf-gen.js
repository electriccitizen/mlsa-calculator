...
process.env.PATH = process.env.PATH + ':' + process.env.LAMBDA_TASK_ROOT + '/functions/pdf-gen/bin';
process.env.LD_LIBRARY_PATH = process.env.LAMBDA_TASK_ROOT + '/functions/pdf-gen/bin'
...
exports.handler = function (event, context,callback) {
  ...
  exec("ls -lah ./src/bin", (error, stdout, stderr) => {
    if (error) {
