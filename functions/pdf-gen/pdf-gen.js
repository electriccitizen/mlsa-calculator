...
process.env.PATH = process.env.PATH + ":" + "/var/task/src/bin"
...
function streamToString(stream, cb) {
  ...
  process.env.PATH = process.env.PATH + ":" + "/var/task/src/bin"
  process.env.LD_LIBRARY_PATH = "/var/task/src/bin"
  ...
  function processData(myData) {
    data["basic.mother.name"] =
      myData.Primary.fname + " " + myData.Primary.lname
    data["basic.father.name"] =
      myData.OtherParent.fname + " " + myData.OtherParent.lname
    return data
  }
